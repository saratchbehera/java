package com.sarat.automatedUKIndexJournals.index.util;
...
public class NaturalOrderComparator implements Comparator
{
	...
	public static boolean isAlpha(char name) {
	    return String.valueOf(name).matches("[a-zA-Z]+");
	}
	
	public static int compareChar(char paramChar1, char paramChar2)
    {
    ...
    private static enum TYPE{ 
        ...
        public static int compare(TYPE a, TYPE b){
            return compareInt(a.getValue(), b.getValue());
        }
    ...
    private int compareAlphaUnits(char a, char b)
    {
        ...
        return compareInt(indexA, indexB);
    }
